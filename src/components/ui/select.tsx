          ...
          >
            <SelectContentContext.Provider value={contentCtx}>
              ...
              <SelectPrimitive.Viewport asChild>
                <Elevated offset={2} shadowLevel={3} ref={(node: HTMLDivElement | null) => {
                ...
                }} onMouseMove={handlers.onMouseMove} onMouseLeave={handlers.onMouseLeave} onFocus={(e: React.FocusEvent<HTMLDivElement>) => {
